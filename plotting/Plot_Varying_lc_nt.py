...
def Plot_Varying_lc_nt(txtdir):
	...
	lc_arr             = np.loadtxt(txtdir + "/lc_array.txt")
	...
	plt.contourf(nt_arr, lc_arr, TC_R_Norm, cont_levs)
	cbar 			   = plt.colorbar()
	...
	plt.contourf(nt_arr, lc_arr, TC_R_imp_rms, cont_levs)
	plt.colorbar()
	plt.xticks(nt_arr)
	plt.yticks(lc_arr)
	plt.xlabel('$n_{t}$')
	...
	plt.contourf(nt_arr, lc_arr, TC_R_unalt_rms, cont_levs)
	plt.colorbar()
	plt.xticks(nt_arr)
	plt.yticks(lc_arr)
	plt.xlabel('$n_{t}$')
	...
	plt.contourf(nt_arr, lc_arr, TC_Phi_1_Norm, cont_levs)
	cbar 			       = plt.colorbar()
	cbar.set_label('${T_{imp}}/{T_{unalt}}$')
	plt.xticks(nt_arr)
	plt.yticks(lc_arr)
	...
	plt.contourf(nt_arr, lc_arr, TC_Phi_1_imp_rms, cont_levs)
	plt.colorbar()
	plt.xticks(nt_arr)
	plt.yticks(lc_arr)
	plt.xlabel('$n_{t}$')
	...
	plt.contourf(nt_arr, lc_arr, TC_Phi_1_unalt_rms, cont_levs)
	plt.colorbar()
	plt.xticks(range(len(nt_arr)), nt_arr)
	plt.yticks(range(len(lc_arr)), lc_arr)
	plt.xlabel('$n_{t}$')
	plt.ylabel('$l_{c}$')
	...
	plt.contourf(nt_arr, lc_arr, TC_Phi_5_Norm, cont_levs)
	cbar 			       = plt.colorbar()
	cbar.set_label('${T_{imp}}/{T_{unalt}}$')
	plt.xticks(nt_arr)
	plt.yticks(lc_arr)
	...
	plt.contourf(nt_arr, lc_arr, TC_Phi_5_imp_rms, cont_levs)
	plt.colorbar()
	plt.xticks(nt_arr)
	plt.yticks(lc_arr)
	plt.xlabel('$n_{t}$')
	...
	plt.contourf(nt_arr, lc_arr, TC_Phi_5_unalt_rms, cont_levs)
	plt.colorbar()
	plt.xticks(nt_arr)
	plt.yticks(lc_arr)
	plt.xlabel('$n_{t}$')
	...
	plt.contourf(nt_arr, lc_arr, TC_A_Norm, cont_levs)
	cbar 			   = plt.colorbar()
	cbar.set_label('${T_{imp}}/{T_{unalt}}$')
	plt.xticks(nt_arr)
	plt.yticks(lc_arr)
	...
	plt.contourf(nt_arr, lc_arr, TC_A_imp_rms, cont_levs)
	plt.colorbar()
	plt.xticks(nt_arr)
	plt.yticks(lc_arr)
	plt.xlabel('$n_{t}$')
	...
	plt.contourf(nt_arr, lc_arr, TC_A_unalt_rms, cont_levs)
	plt.colorbar()
	plt.xticks(nt_arr)
	plt.yticks(lc_arr)
	plt.xlabel('$n_{t}$')
