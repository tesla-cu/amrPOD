...
if __name__ == '__main__':
    ...
    l3_arr      = np.arange(0.0, 10/27, 1/27) # spanning l3
    ...
    for ixval, xval in enumerate(xvals):
        for iyval, yval in enumerate(yvals):
            for izval, zval in enumerate(zvals):
                l1 = xval # less confusing
                l2 = yval # less confusing
                l3 = zval # less confusing

                print('l1 = %0.6f, l2 = %0.6f, l3 = %0.6f' % (l1, l2, l3))

                # Since we have l in our vars, we need to get ls
                ls = np.array([1.0-l1-l2-l3, l1, l2, l3])
