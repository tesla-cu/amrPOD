...
if __name__ == '__main__':
    ...
    xvals = l0_arr # what will be plotted on the x-axis
    ...
    for ixval, xval in enumerate(xvals):
        for iyval, yval in enumerate(yvals):
            ...
            print('l0 = %0.6f, l1 = %0.6f' % (l0, l1))

            # Since we have l in our vars, we need to get ls
            ls  = np.array([l0, l1, 1.0-l0-l1])
            lcs = np.array([l0, l1, 1.0-l0-l1])
    ...
    plot_single(txtdir, imgdir, compute_tc, compute_cpu, xvals, yvals, 'lc0 and l0', 'lc1 and l1')
